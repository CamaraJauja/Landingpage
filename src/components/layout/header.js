    ...
    return (
        <header className="sticky w-full h bg-white z-header lg:h" style={{"--h": "60px", "--h-lg": "80px"}}>
            <div className="w m-auto h-full flex items-center justify-between" style={{"--w": "90%"}}>
                <Link href={'#'} className="relative block w h lg:w lg:h" style={{"--w": "120px", "--h": "45px", "--w-lg": "180px", "--h-lg": "50px"}}>
                    <Image src={'/LOGO - PRIMARY.svg'} alt="Logo" fill loading="eager" />
                </Link>
                <div className="flex items-center gap-md">
                    ...
                    <div className="flex">
                        <Link href={'#register'} className="btn btn-primary btn-sm rounded-full lg:btn-lg">Quiero inscribirme</Link>
